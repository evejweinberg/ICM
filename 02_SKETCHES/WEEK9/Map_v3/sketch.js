...
function setup() {
  ...
  // var header = loadImage('assets/title.gif');
  var train1 = loadImage('assets/train1red.png');
  var train2 = loadImage('assets/train2red.png');
  var train3 = loadImage('assets/train3red.png');
  var train4 = loadImage('assets/train4red.png');
