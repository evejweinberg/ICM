...
DashedLine(0,height*.95, 0);
    DashedLine(0,height*.05, 0);
...
function TriangleBackground() {
  ...
  this.display = function() {
    stroke(palettebluepink[this.colorIndex], 60); //want this to be a random color from my array
    var mouseradius = 100;
    strokeWeight(5);
    this.opacity = 70;
...
//i want to map saturation onto this center with distance mapping to sat. 
    ...
    if (mouseX > this.Centerposition.x + (-1 * mouseradius) && mouseX < this.Centerposition.x + (mouseradius) && mouseY > this.Centerposition.y + (-1 * mouseradius) && mouseY < this.Centerposition.y + (mouseradius)) {
      ...
      if (mouseX > this.Centerposition.x + (-3 * mouseradius) && mouseX < this.Centerposition.x + (mouseradius*3) && mouseY > this.Centerposition.y + (-1 * mouseradius) && mouseY < this.Centerposition.y + (mouseradius)) {
      this.opacity = 50;
      fill(90, 60);
      strokeWeight(0);
      stroke(palettebluepink[this.colorIndex], 30);
